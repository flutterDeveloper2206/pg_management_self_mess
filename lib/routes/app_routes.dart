...
class AppRoutes {
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
      ...
      bindings: [AddStudentScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [StudentListScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [ExpenseListScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [AddExpenseScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [AllDetailsListScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [DayDetailsListScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [AddUpdateDayDetailsScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [GanarateBillScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [MonthlyTransactionScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [DepositDetailsScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
      ...
      bindings: [StudentProfileScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
    ...
    GetPage(
      ...
      bindings: [ImportDataScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
    GetPage(
    ...
    GetPage(
      ...
      bindings: [SendNotificationScreenBinding()],
      transition: Transition.rightToLeft,
      transitionDuration: const Duration(milliseconds: 100),
    ),
  ];
