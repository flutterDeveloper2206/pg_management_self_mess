            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  controller.isAdd.value != 2
                      ? AppElevatedButton(
                          buttonName: controller.isAdd.value == 1
                              ? 'Update '
                              : 'Save',
                          onPressed: () {
                            if (controller.isAdd.value == 1 &&
                                controller.dataGet.value.status ==
                                    'generated') {
                              AppFlushBars.appCommonFlushBar(
                                context: NavigationService
                                    ...
                                    .currentContext!,
                                message:
                                    'Please first lock (Finalize) your bill , after enter paid entry!',
                                success: false,
                              );
                            } else {
